...
<!DOCTYPE html>
<html lang="en">
    <!-- rev 0.7  © 2023 FiFo Labs. -->

    <head>
        <title>FiFo Labs</title>
        <meta charset="utf-8"/>
        <meta name="viewport" content="width=device-width,initial-scale=1"/>
        <meta name="color-scheme" content="light only"/>
        <meta name="description" content="20,000 unique personal Ai interns working for You, while You Sleep. S2E"/>
        <meta property="og:site_name" content="FiFoLabs.xyz"/>
        <meta property="og:title" content="FiFo Labs"/>
        <meta property="og:type" content="website"/>
        <meta property="og:description" content="20,000 unique personal Ai interns working for You, while You Sleep. S2E"/>
        <link rel="icon" type="image/png" sizes="24x24" href="https://ipfs.io/ipfs/QmSVX6skuk2pKqjVc6ZB3Tswh4kySzkqfXNt21TtPRavgm" />
        <meta property="og:image" content="https://ipfs.io/ipfs/QmT9W5NwJ9CceT9u3rfpYwwyonTGr3pxeV8YpBBPsNwLX7"/>
        <meta property="og:image:width" content="1200"/>
        <meta property="og:image:height" content="600"/>
        <meta property="og:url" content="https://FiFoLabs.xyz"/>
        <meta property="twitter:card" content="summary_large_image"/>
        <link rel="canonical" href="https://FiFo.Labs.xyz"/>
        <link href="https://fonts.googleapis.com/css?family=Silkscreen:400,400italic%7CInter:500,500italic,600,600italic,400,400italic" rel="stylesheet" type="text/css"/>
            ...
            <div id="wrapper">
                ...
                <div class="wrapper">
                    <div class="inner" data-onvisible-trigger="1">
                        <h1 id="text11" class="style3">FiFo Labs</h1>
                        <p id="text01" class="style2">20,000 unique personal Ai interns on the blockchain with commercial rights.</p>

                        <div id="container05" class="style1 container default">
                            <div class="wrapper">
                                <div class="inner" data-onvisible-trigger="1" style="padding: 20px;">
                                    <ul id="buttons01" class="style1 buttons">
                                        <li>
                                            <a href="https://youtu.be/iiE7-mihBCU?feature=shared" target="_blank" class="button n01">
                                                <span class="label">Ai Phils YouTube debut</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <p id="text13" class="style9">
                                <a href="https://www.dextools.io/app/en/ether/pair-explorer/0xe5cf489df5fd1c1e3710bef745d044885f66504d" target="_blank">Dex Tools</a><br>
                                <a href="https://twitter.com/FiFoLabs" target="_blank">FiFo Labs Twitter</a><br>FiFoLabs69@gmail.com<br>
                                <a href="https://etherscan.io/token/0xf853fa36113e54afc3f6e7349c665ba872a73761" target="_blank">Etherscan</a><br>
                                <a href="https://www.geckoterminal.com/eth/pools/0xe5cf489df5fd1c1e3710bef745d044885f66504d" target="_blank">Gecko Terminal</a><br>
                                <a href="https://t.co/011Ifc7y9G" target="_blank">Discord Invite</a>
                            </p>
                    </div>
                </div>
            </div>          
                    <section id="home-section">
                        ...
                        <div id="image01" class="style1 image full screen" data-position="center">
                            <span class="frame">
                                <img src="https://ipfs.io/ipfs/QmdpAUDqDT6xLFJgQVG1imFhLoiSMthmvKGmXb2BvAPhv7" alt=""/>
                            </span>
                            <div id="container05" class="style1 container default">
                                <div class="wrapper">
                                    <div class="inner" data-onvisible-trigger="1" style="padding: px;">
                                        <ul id="buttons02" class="style1 buttons">
                                            <li>
                                                <a href="https://mirror.xyz/0x1Fc5fdF0C51763A48e48Bcaa737C5FfE38A648F3/a81NcMuGq7QY01TaLw11Ivs7ruikIEPZHcKTmU34HIQ" target="_blank" class="button n01">
                                                    <span class="label">FiFo Labs Whitepaper</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div id="container05" class="style1 container default">
                                <div class="wrapper">
                                    <div class="inner" data-onvisible-trigger="1">
                                        <ul id="buttons02" class="style1 buttons">
                                            <li>
                                                <a href="https://opensea.io/collection/fifo-phil" target="_blank" class="button n01">
                                                    <span class="label">FiFo Phil Opensea</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div id="image01" class="style1 image full screen" data-position="center">
                            <span class="frame">
                                <img src="https://ipfs.io/ipfs/QmUHz43wSKm9UorWdjTTWU6EUZFRsj5b9SwCCqo9JpBsRa" alt=""/>
                            </span>
                        </div>


                        <h2 id="text05" class="style3">STAKING is Live</h2>
                        <p id="text17" class="style9" style="opacity: 1; transform: none;"><a href="https://etherscan.io/address/0x374b2Dfa49D01Fe1EeDB9e58Db7Ee113D290840A" target="_blank">FiFo Mine Etherscan</a></p>
                        <p id="text06" class="style2">Send FiFo Phil on a Quest in the FiFo Mine for the Mystical $FGem</p>
                        ...
                        <div id="container05" class="style1 container default">
                            <div class="wrapper">
                                <div class="inner" data-onvisible-trigger="1">
                                    <ul id="buttons01" class="style1 buttons">
                                        <li>
                                            <a href="https://twitter.com/FiFoLabs/status/1713384015141699675" target="_blank" class="button n01">
                                                <span class="label">Staking Thread</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div id="container03" class="style1 container default">
                            <div class="wrapper">
                                <div class="inner" data-onvisible-trigger="1">
                                    <h2 id="text03" class="style3">WE are FiFo Labs</h2>
                                    <h2 id="text03" class="style2">est. Apr 2023</h2>
                                    <p id="text06" class="style2">Who: A group of artists, networkers, businessmen, and developers looking to take back the NFT space.</p>
                                    <p id="text06" class="style2">What: FiFo Labs, $FiFo staking, and our genesis PFP “FiFo Phil” was the beginning of FiFo Labs.</p>
                                    <p id="text06" class="style2">Where: Ethereum and possibly more blockchain(s) in the future.</p>
                                    <p id="text06" class="style2">When: FiFo Labs started in late 2023, but the team consists of creatives that have worked together 3+ years.</p>
                                    <p id="text06" class="style2">Why: FiFo Labs is here to create unique experiences for our growing community.</p>
                                    <br>
                                    <br>
                                    <br>
                        ...
                        <div id="image12" class="style1 image full screen" data-position="center">
                            <span class="frame">
                                <img src="https://ipfs.io/ipfs/QmZWKvA9PBxrzAEFKg6LhJxjhTSA8K64hK1DLmBiZSjfCK" alt=""/>
                            </span>
                        </div>
                        <p id="text17" class="style9" style="opacity: 1; transform: none;">Created by <a href="https://twitter.com/FiFoLabs" target="_blank">FiFo Labs</a> • All rights reserved.</p>
                    </section>
                    
                    <section id="licenseterms-section">
        ...
        <style>
            ...
            *, *:before, *:after {
            ...
            h1.style3, h2.style3, h3.style3, p.style3 {
                ...
                line-height: 1.125;
                font-weight: 400;
                text-shadow: 0rem 0rem 0.75rem #66ff00;
            }
            ...
            .buttons.style1 .button {
                ...
                color: #020052;
                background-image: linear-gradient(45deg, #66ff00 0%, rgba(255,138,0,0.008) 100%);
                background-position: 0% 0%;
                background-repeat: repeat;
                background-size: cover;
            }
        ...
        <script>
            (function() {
                ...
                onvisible.add('h1.style10, h2.style10, h3.style10, p.style10', {
                    style: 'fade-down',
                    speed: 500,
                    intensity: 3,
                    delay: 0,
