!function e(t, r, n) {
    ...
    , {
        "../../shared/modules/provider-injection": 147,
        "@metamask/post-message-stream": 8,
        "@metamask/providers/dist/initializeInpageProvider": 27,
        loglevel: 80
    }],
    2: [function(e, t, r) {
        "use strict";
        ...
        (function(r, n) {
            (function() {
                ...
                function w(e, t, r, n, i) {
                    ...
                    o.objectMode || 0 !== t.length ? _(e, o, t, !1) : M(e, o)) : _(e, o, t, !1))) : n || (o.reading = !1));
                    return function(e) {
    ...
    24: [function(e, t, r) {
        ...
        class l extends i.default {
            constructor({logger: e=console, maxEventListeners: t=100, rpcMiddleware: r=[]}={}) {
                ...
                this._state = Object.assign({}, l._defaultState),
    ...
    25: [function(e, t, r) {
        ...
        class c extends u.AbstractStreamProvider {
            constructor(e, {jsonRpcStreamName: t=r.MetaMaskInpageProviderStreamName, logger: n=console, maxEventListeners: i, shouldSendMetadata: o}={}) {
                if (super(e, {
                    jsonRpcStreamName: t,
                    logger: n,
                    maxEventListeners: i,
                ...
                this._jsonRpcConnection.events.on("notification", (e=>{
                    const {method: t} = e;
                    a.EMITTED_NOTIFICATIONS.includes(t) && (this.emit("data", e),
                    this.emit("notification", e.params.result))
                }
                )),
                o)
                    if ("complete" === document.readyState)
                        s.sendSiteMetadata(this._rpcEngine, this._log);
                    else {
                        const e = ()=>{
                            s.sendSiteMetadata(this._rpcEngine, this._log),
            ...
            _warnOfDeprecation(e) {
                var t;
                !1 === (null === (t = this._sentWarnings) || void 0 === t ? void 0 : t.events[e]) && (this._log.warn(o.default.warnings.events[e]),
                this._sentWarnings.events[e] = !0)
            }
            enable() {
                return this._sentWarnings.enable || (this._log.warn(o.default.warnings.enableDeprecation),
            ...
            send(e, t) {
                return this._sentWarnings.send || (this._log.warn(o.default.warnings.sendDeprecation),
            ...
            _sendSync(e) {
                ...
                case "net_version":
                    ...
                    break;
                default:
                    throw new Error(o.default.errors.unsupportedSync(e.method))
                }
                return {
                    id: e.id,
                    jsonrpc: e.jsonrpc,
            ...
            _getExperimentalApi() {
                return new Proxy({
                    ...
                    get: (e,t,...r)=>(this._sentWarnings.experimentalMethods || (this._log.warn(o.default.warnings.experimentalMethods),
    ...
    26: [function(e, t, r) {
        ...
        const i = n(e("@metamask/object-multiplex"))
          ...
          , c = e("./utils")
          , l = e("./BaseProvider");
        class f extends l.BaseProvider {
            constructor(e, {jsonRpcStreamName: t, logger: r, maxEventListeners: n, rpcMiddleware: l}) {
                if (super({
                    logger: r,
                    maxEventListeners: n,
                    rpcMiddleware: l
                ...
                this._jsonRpcConnection = o.createStreamMiddleware({
                ...
                this._jsonRpcConnection.events.on("notification", (t=>{
                    ...
                    "metamask_accountsChanged" === r ? this._handleAccountsChanged(n) : "metamask_unlockStateChanged" === r ? this._handleUnlockStateChanged(n) : "metamask_chainChanged" === r ? this._handleChainChanged(n) : c.EMITTED_NOTIFICATIONS.includes(r) ? this.emit("message", {
                        type: r,
                        data: n
            ...
            _handleChainChanged({chainId: e, networkVersion: t}={}) {
                c.isValidChainId(e) && c.isValidNetworkVersion(t) ? "loading" === t ? this._handleDisconnect(!0) : super._handleChainChanged({
                    chainId: e
    ...
    29: [function(e, t, r) {
        ...
        r.createRpcWarningMiddleware = function(e) {
            ...
            return (r,n,s)=>{
                !1 === t.ethDecryptDeprecation && "eth_decrypt" === r.method ? (e.warn(i.default.warnings.rpc.ethDecryptDeprecation),
                t.ethDecryptDeprecation = !0) : !1 === t.ethGetEncryptionPublicKeyDeprecation && "eth_getEncryptionPublicKey" === r.method && (e.warn(i.default.warnings.rpc.ethGetEncryptionPublicKeyDeprecation),
    ...
    32: [function(e, t, r) {
        ...
        r.getDefaultExternalMiddleware = (e=console)=>{
            return [n.createIdRemapMiddleware(), (t = e,
            (e,r,n)=>{
    ...
    , {
        "./middleware/createRpcWarningMiddleware": 29,
        "eth-rpc-errors": 62,
        "json-rpc-engine": 75
    }],
    33: [function(e, t, r) {
    ...
    37: [function(e, t, r) {
        (function(t) {
            (function() {
                ...
                function a(e) {
                    (0,
                    n.assert)(o(e), "Value must be a Uint8Array.")
                }
                function u(e) {
                    if (a(e),
                    0 === e.length)
                ...
                function p(e) {
                    ...
                    if ("number" == typeof e)
                        return h(e);
                    if ("string" == typeof e)
                        return e.startsWith("0x") ? l(e) : d(e);
                    if (o(e))
                        return e;
            ...
            return function e(t, n) {
                ...
                try {
                    ...
                    if ("boolean" === i || t instanceof Boolean)
                        return n ? [!0, 0] : [!0, 1 == t ? s.JsonSize.True : s.JsonSize.False];
                    if ("number" === i || t instanceof Number)
                        return n ? [!0, 0] : [!0, (0,
                        s.calculateNumberSize)(t)];
                    if (t instanceof Date)
                        return n ? [!0, 0] : [!0, isNaN(t.getDate()) ? s.JsonSize.Null : s.JsonSize.Date + 2 * s.JsonSize.Quote]
                } catch (e) {
                    return [!1, 0]
                }
                if (!(0,
                s.isPlainObject)(t) && !Array.isArray(t))
                    return [!1, 0];
                if (r.has(t))
                    return [!1, 0];
                r.add(t);
                try {
                    return [!0, Object.entries(t).reduce(((i,[o,a],u,c)=>{
                        ...
                        n)
                            return 0;
                        return i + (Array.isArray(t) ? 0 : o.length + s.JsonSize.Comma + 2 * s.JsonSize.Colon) + f + (u < c.length - 1 ? s.JsonSize.Comma : 0)
                    }
    ...
    50: [function(e, t, r) {
        ...
        r.toByteArray = function(e) {
            var t, r, n = c(e), o = n[0], a = n[1], u = new s(function(e, t, r) {
                return 3 * (t + r) / 4 - r
        ...
        ;
        for (var n = [], i = [], s = "undefined" != typeof Uint8Array ? Uint8Array : Array, o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", a = 0, u = o.length; a < u; ++a)
            n[a] = o[a],
            i[o.charCodeAt(a)] = a;
        function c(e) {
            var t = e.length;
 ...
 */
    ...
    53: [function(e, t, r) {
        ...
        function p(e, t, r, n, i, s) {
            if (t)
                ...
                for (var o = e.length, a = _(e, o), u = 0; u < o; ++u)
                    a[u].call(r, n, i, s)
        }
        function g(e, t, r, n) {
            if (t)
    ...
    63: [function(e, t, r) {
        ...
        r.isValidCode = u,
        r.serializeError = function(e, {fallbackError: t=o, shouldIncludeStack: r=!1}={}) {
            var n, s;
            ...
            const h = null === (s = e) || void 0 === s ? void 0 : s.stack;
            return r && e && h && "string" == typeof h && (c.stack = h),
            c
        }
    }
    , {
 ...
 */
    ...
    , {
        "./JsonRpcEngine": 70,
        "./createAsyncMiddleware": 71,
        "./createScaffoldMiddleware": 72,
        "./getUniqueId": 73,
        "./idRemapMiddleware": 74,
        "./mergeMiddleware": 76
    }],
    76: [function(e, t, r) {
        "use strict";
    ...
    , {
        "./createEngineStream": 77,
        "./createStreamMiddleware": 78
    }],
    80: [function(e, t, r) {
        !function(e, r) {
            "use strict";
            ...
            function u(e, r, n) {
                return function() {
                    typeof console !== t && (a.call(this, r, n),
            ...
            function l(e, r, i) {
                ...
                ,
                o.setLevel = function(r, i) {
                    if ("string" == typeof r && void 0 !== o.levels[r.toUpperCase()] && (r = o.levels[r.toUpperCase()]),
                    !("number" == typeof r && r >= 0 && r <= o.levels.SILENT))
            ...
            f.getLogger = function(e) {
                ...
                var t = h[e];
                return t || (t = h[e] = new l(e,f.getLevel(),f.methodFactory)),
                t
            }
            ;
            var d = typeof window !== t ? window.log : void 0;
            return f.noConflict = function() {
                return typeof window !== t && window.log === f && (window.log = d),
                f
            }
            ,
    ...
    97: [function(e, t, r) {
        class n {
            constructor(e, t) {
                ...
                this.raw = e,
                this.set = e.split("||").map((e=>this.parseRange(e.trim()))).filter((e=>e.length)),
                !this.set.length)
            ...
            parseRange(e) {
                ...
                a("comparator trim", e);
                let u = (e = (e = (e = e.replace(c[l.TILDETRIM], h)).replace(c[l.CARETTRIM], d)).split(/\s+/).join(" ")).split(" ").map((e=>y(e, this.options))).join(" ").split(/\s+/).map((e=>M(e, this.options)));
                n && (u = u.filter((e=>(a("loose invalid filter", e, this.options),
                !!e.match(c[l.COMPARATORLOOSE]))))),
                a("range list", u);
                const g = new Map
                  , m = u.map((e=>new o(e,this.options)));
                for (const e of m) {
                    if (p(e))
                        return [e];
                    g.set(e.value, e)
            ...
            test(e) {
                ...
                for (let t = 0; t < this.set.length; t++)
                    if (k(this.set[t], e, this.options))
                        return !0;
                return !1
            }
        }
        ...
        const i = new (e("lru-cache"))({
          ...
          , a = e("../internal/debug")
          , u = e("./semver")
          , {re: c, t: l, comparatorTrimReplace: f, tildeTrimReplace: h, caretTrimReplace: d} = e("../internal/re")
          , p = e=>"<0.0.0-0" === e.value
          , g = e=>"" === e.value
          , m = (e,t)=>{
            let r = !0;
        ...
        e)
          ...
          , w = (e,t)=>{
            ...
            return e.replace(r, ((t,r,n,i,s)=>{
                ...
                v(r) ? o = "" : v(n) ? o = `>=${r}.0.0 <${+r + 1}.0.0-0` : v(i) ? o = `>=${r}.${n}.0 <${r}.${+n + 1}.0-0` : s ? (a("replaceTilde pr", s),
          ...
          , E = (e,t)=>{
            ...
            return e.replace(r, ((t,r,i,s,o)=>{
                ...
                v(r) ? u = "" : v(i) ? u = `>=${r}.0.0${n} <${+r + 1}.0.0-0` : v(s) ? u = "0" === r ? `>=${r}.${i}.0${n} <${r}.${+i + 1}.0-0` : `>=${r}.${i}.0${n} <${+r + 1}.0.0-0` : o ? (a("replaceCaret pr", o),
        ...
        e.trim().replace(c[l.STAR], ""))
          , M = (e,t)=>(a("replaceGTE0", e, t),
        e.trim().replace(c[t.includePrerelease ? l.GTE0PRE : l.GTE0], ""))
          , C = e=>(t,r,n,i,s,o,a,u,c,l,f,h,d)=>`${r = v(n) ? "" : v(i) ? `>=${n}.0.0${e ? "-0" : ""}` : v(s) ? `>=${n}.${i}.0${e ? "-0" : ""}` : o ? `>=${r}` : `>=${r}${e ? "-0" : ""}`} ${u = v(c) ? "" : v(l) ? `<${+c + 1}.0.0-0` : v(f) ? `<${c}.${+l + 1}.0-0` : h ? `<=${c}.${l}.${f}-${h}` : e ? `<${c}.${l}.${+f + 1}-0` : `<=${u}`}`.trim()
          , k = (e,t,r)=>{
            for (let r = 0; r < e.length; r++)
                if (!e[r].test(t))
                    return !1;
    ...
    , {
        "../internal/constants": 124,
        "../internal/debug": 125,
        "../internal/identifiers": 126,
        "../internal/parse-options": 127,
        "../internal/re": 128
    }],
    99: [function(e, t, r) {
        ...
        t.exports = (e,t)=>{
                ...
                return null;
            {
                const r = n(e)
                  ...
                  , a = s ? "prerelease" : "";
                for (const e in r)
                    if (("major" === e || "minor" === e || "patch" === e) && r[e] !== i[e])
                        return o + e;
                return a
            }
        }
    ...
    115: [function(e, t, r) {
        const {MAX_LENGTH: n} = e("../internal/constants")
          , {re: i, t: s} = e("../internal/re")
          , o = e("../classes/semver")
          , a = e("../internal/parse-options");
        t.exports = (e,t)=>{
            if (t = a(t),
            e instanceof o)
                return e;
    ...
    , {
        "./classes/comparator": 96,
        "./classes/range": 97,
        "./classes/semver": 98,
        "./functions/clean": 99,
        "./functions/cmp": 100,
        "./functions/coerce": 101,
        "./functions/compare": 104,
        "./functions/compare-build": 102,
        "./functions/compare-loose": 103,
        "./functions/diff": 105,
        "./functions/eq": 106,
        "./functions/gt": 107,
        "./functions/gte": 108,
        ...
        "./functions/parse": 115,
        "./functions/patch": 116,
        "./functions/prerelease": 117,
        "./functions/rcompare": 118,
        "./functions/rsort": 119,
        "./functions/satisfies": 120,
        "./functions/sort": 121,
        "./functions/valid": 122,
        "./internal/constants": 124,
        "./internal/identifiers": 126,
        "./internal/re": 128,
        "./ranges/gtr": 130,
        "./ranges/intersects": 131,
        "./ranges/ltr": 132,
        "./ranges/max-satisfying": 133,
        "./ranges/min-satisfying": 134,
        "./ranges/min-version": 135,
        "./ranges/outside": 136,
        "./ranges/simplify": 137,
        "./ranges/subset": 138,
        "./ranges/to-comparators": 139,
        "./ranges/valid": 140
    }],
    124: [function(e, t, r) {
    ...
    , {}],
    128: [function(e, t, r) {
        const {MAX_SAFE_COMPONENT_LENGTH: n} = e("./constants")
          , i = e("./debug")
          , s = (r = t.exports = {}).re = []
          , o = r.src = []
          , a = r.t = {};
    ...
    , {
        "../functions/compare.js": 104,
        "../functions/satisfies.js": 120
    }],
    138: [function(e, t, r) {
        const n = e("../classes/range.js")
          ...
          , u = (e,t,r)=>{
            ...
            let u, f, h, d, p, g, m;
            for (const t of e)
                ">" === t.operator || ">=" === t.operator ? u = c(u, t, r) : "<" === t.operator || "<=" === t.operator ? f = l(f, t, r) : n.add(t.semver);
            if (n.size > 1)
                return null;
            if (u && f) {
                if (h = a(u.semver, f.semver, r),
                h > 0)
                    return null;
                if (0 === h && (">=" !== u.operator || "<=" !== f.operator))
                    return null
            }
            for (const e of n) {
                if (u && !o(e, String(u), r))
            ...
            let y = !(!f || r.includePrerelease || !f.semver.prerelease.length) && f.semver
              , v = !(!u || r.includePrerelease || !u.semver.prerelease.length) && u.semver;
            y && 1 === y.prerelease.length && "<" === f.operator && 0 === y.prerelease[0] && (y = !1);
            for (const e of t) {
                ...
                u)
                    ...
                    ">" === e.operator || ">=" === e.operator) {
                        ...
                        d === e && d !== u)
                            return !1
                    } else if (">=" === u.operator && !o(u.semver, String(e), r))
                        return !1;
                if (f)
                    ...
                    "<" === e.operator || "<=" === e.operator) {
                        ...
                        p === e && p !== f)
                            return !1
                    } else if ("<=" === f.operator && !o(f.semver, String(e), r))
                        return !1;
                if (!e.operator && (f || u) && 0 !== h)
                    return !1
            }
            return !(u && g && !f && 0 !== h) && (!(f && m && !u && 0 !== h) && (!v && !y))
        }
          , c = (e,t,r)=>{
            if (!e)
                return t;
    ...
    147: [function(e, t, r) {
        ...
        r.default = function() {
            return function() {
                ...
                const e = ["uscourts.gov", "dropbox.com", "webbyawards.com", "cdn.shopify.com/s/javascripts/tricorder/xtld-read-only-frame.html", "adyen.com", "gravityforms.com", "harbourair.com", "ani.gamer.com.tw", "blueskybooking.com", "sharefile.com"]
